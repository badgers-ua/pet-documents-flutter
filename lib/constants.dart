...
class Api {
  ...
  // static const baseUrl = 'http://192.168.0.170:5000/api/v2';
  // static const baseUrl = 'http://localhost:5000/api/v2';
}

class AboutAppConstants {
  static const supportEmail = 'n/a@gmail.com';
  static const termsUrl = 'https://na.com/terms';
  static const privacyUrl = 'https://na.com/privacy';
}
